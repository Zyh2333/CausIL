...
def collect_graph(config: Config, _dir: str, collect: bool) -> Dict[str, nx.DiGraph]:
    ...
    node_center: Dict[str, str] = {'izbp16opgy3xucvexwqp9dz': 'cloud',
                                   ...
                                   'server-3': 'edge-2',
                                   'dell2018': 'edge-2'}
    masks = ['ingress', 'unknown', 'load-pod', 'load-pod-cloud', 'istio-ingressgateway', 'ratings-v1-edge', 'productpage-v1-edge', 'recommendationservice-edge', 'productcatalogservice-edge', 'cartservice-edge', 'frontend-edge', 'carts-cloud-hxv26', 'carts-cloud-czcwz', 'carts-cloud-jlt67', 'carts-cloud-jjn2j', 'payment-cloud-n9s7t', 'carts-edge-1-rb4kd']
